...
class DebtPaymentTest {
    ...
    void createPaymentWorks() {
        DebtPayment payment = DebtPayment.create(1L, 2L, 10L, DebtPaymentType.INSTALLMENT, Money.cop(new BigDecimal("50000")), LocalDate.of(2026, 5, 11), "First payment");
    ...
    void rejectInvalidAmount() {
        assertThatThrownBy(() -> DebtPayment.create(1L, 2L, 10L, DebtPaymentType.INSTALLMENT, Money.zeroCop(), LocalDate.now(), null))
    ...
    void rejectMissingDate() {
        assertThatThrownBy(() -> DebtPayment.create(1L, 2L, 10L, DebtPaymentType.INSTALLMENT, Money.cop(new BigDecimal("50000")), null, null))
    ...
    void rejectMissingType() {
        assertThatThrownBy(() -> DebtPayment.create(1L, 2L, 10L, null, Money.cop(new BigDecimal("50000")), LocalDate.now(), null))
