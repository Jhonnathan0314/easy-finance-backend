...
@SpringJUnitWebConfig(classes = DebtPaymentsControllerSecurityTest.TestConfig.class)
class DebtPaymentsControllerSecurityTest {
    ...
    @Test
    void paymentsRequireToken() throws Exception {
    ...
    void invalidTokenReturnsUnauthorized() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/accounts/1/debts/5/payments").header("Authorization", "Bearer bad-token"))
                .andExpect(status().isUnauthorized())
    ...
    @EnableWebMvc
    @EnableWebSecurity
    @Import({DebtPaymentsController.class, SecurityConfig.class, JwtAuthenticationFilter.class, RestSecurityExceptionHandler.class})
    static class TestConfig {
        @Bean RegisterDebtPaymentPort registerDebtPaymentPort() { return mock(RegisterDebtPaymentPort.class); }
        @Bean ListDebtPaymentsPort listDebtPaymentsPort() { return mock(ListDebtPaymentsPort.class); }
        @Bean GetDebtPaymentPort getDebtPaymentPort() { return mock(GetDebtPaymentPort.class); }
