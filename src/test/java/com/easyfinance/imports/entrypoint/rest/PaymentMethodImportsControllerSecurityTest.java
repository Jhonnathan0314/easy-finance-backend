...
@SpringJUnitWebConfig(classes = PaymentMethodImportsControllerSecurityTest.TestConfig.class)
class PaymentMethodImportsControllerSecurityTest {
    ...
    void invalidTokenReturnsUnauthorized() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/accounts/1/imports/payment-methods/template").header("Authorization", "Bearer bad-token"))
                .andExpect(status().isUnauthorized())
    ...
    @EnableWebMvc
    @EnableWebSecurity
    @Import({PaymentMethodImportsController.class, SecurityConfig.class, JwtAuthenticationFilter.class, RestSecurityExceptionHandler.class})
