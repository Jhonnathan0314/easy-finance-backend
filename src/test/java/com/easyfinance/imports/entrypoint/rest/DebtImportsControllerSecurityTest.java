...
@SpringJUnitWebConfig(classes = DebtImportsControllerSecurityTest.TestConfig.class)
class DebtImportsControllerSecurityTest {
    ...
    void invalidTokenReturnsUnauthorized() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/accounts/1/imports/debts/template").header("Authorization", "Bearer bad-token"))
                .andExpect(status().isUnauthorized())
    ...
    @EnableWebMvc
    @EnableWebSecurity
    @Import({DebtImportsController.class, SecurityConfig.class, JwtAuthenticationFilter.class, RestSecurityExceptionHandler.class})
    static class TestConfig {
        @Bean GenerateDebtImportTemplatePort generateDebtImportTemplatePort() { return mock(GenerateDebtImportTemplatePort.class); }
        @Bean ImportDebtPort importDebtPort() { return mock(ImportDebtPort.class); }
        @Bean PreviewDebtImportPort previewDebtImportPort() { return mock(PreviewDebtImportPort.class); }
