...
public final class DebtPayment {
    ...
    public static DebtPayment create(
        ...
        return new DebtPayment(null, accountId, debtId, participantId, paymentType, amount, paymentDate, notes, DebtPaymentStatus.ACTIVE, null, null);
    }
    ...
    public static DebtPayment restore(
        ...
        return new DebtPayment(id, accountId, debtId, participantId, paymentType, amount, paymentDate, notes, status, createdAt, updatedAt);
    }
