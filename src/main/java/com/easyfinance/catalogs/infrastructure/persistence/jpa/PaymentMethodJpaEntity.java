...
public class PaymentMethodJpaEntity extends AuditableJpaEntity {
    ...
    private PaymentMethodTypeJpa type;
    ...
    public PaymentMethodTypeJpa getType() {
        return type;
    }

    public void setType(PaymentMethodTypeJpa type) {
        this.type = type;
    }
