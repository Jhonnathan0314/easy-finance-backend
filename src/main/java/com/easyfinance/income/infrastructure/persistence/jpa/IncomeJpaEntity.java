...
@Entity
@Table(name = "incomes")
public class IncomeJpaEntity extends AuditableJpaEntity {
    ...
    private IncomeStatusJpa status;
    ...
    public IncomeStatusJpa getStatus() { return status; }
    public void setStatus(IncomeStatusJpa status) { this.status = status; }
}
